...
import {
  VacancySuperjob,
  VacancySuperjobMultipleResponse,
} from "./types/VacancySuperjob";
...
export class VacancyService {
  ...
  static async getSuperjob(
    params: SuperjobParams,
    signal: AbortSignal,
  ): Promise<AxiosResponse<VacancySuperjobMultipleResponse>> {
  ...
  static async getSuperjobById(
    id: string,
    signal: AbortSignal,
  ): Promise<AxiosResponse<VacancySuperjob>> {
    return await axios.get(this.baseURL, {
      signal,
      headers: {
        "X-Api-App-Id": this.SUPERJOB_API_APP_KEY,
  ...
  static async getSuperjobByIds(
    ...
    return await axios.get(this.baseURL, {
      ...
      headers: {
        "X-Api-App-Id": this.SUPERJOB_API_APP_KEY,
        "X-Target-Url":
          sourcesRegistry.superjob.url.api +
          "/vacancies/?" +
          ids.map((el, i) => `ids[${i}]=${el}`).join("&"),
      },
    });
  }

  static async getSuperjobOnlineStatus(
    signal: AbortSignal,
  ...
  static async getHH(
    params: HHParams,
    signal: AbortSignal,
  ): Promise<AxiosResponse<VacancyHHMultipleResponse>> {
    return await axios.get(this.baseURL, {
      params,
      signal,
      headers: {
  ...
  static async getHHById(
    id: string,
    signal: AbortSignal,
  ): Promise<AxiosResponse<VacancyHHById>> {
    return await axios.get(this.baseURL, {
      signal,
      headers: {
  ...
  static async getTrudvsem(
    params: TrudvsemParams,
    signal: AbortSignal,
    additionalEndpoint?: string,
  ): Promise<AxiosResponse<VacancyTrudvsemResponse>> {
    return await axios.get(this.baseURL, {
      params,
      signal,
      headers: {
        ...
        "X-Target-Url":
          sourcesRegistry.trudvsem.url.api +
          "/vacancies/" +
          (additionalEndpoint || ""),
      },
    });
  ...
  static async getTrudvsemById(
    ...
    return await axios.get(this.baseURL, {
      ...
      headers: {
        "X-Target-Url":
          sourcesRegistry.trudvsem.url.api +
          `/vacancies/vacancy/${companyId}/${id}`,
      },
    });
  }
}
