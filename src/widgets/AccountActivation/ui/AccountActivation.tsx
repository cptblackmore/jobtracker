...
export const AccountActivation: React.FC = observer(() => {
  ...
  return !authStore.user.isActivated ? (
    <>
      <Divider />
      <Box
        component="section"
      ...
      >
        <CardHeader
          title={
            <CardHeaderTitle
              id={accountPageElementsIds.activationSectionTitle}
              title="Активация"
            />
          }
          sx={{ pb: { xs: 1, sm: 2 } }}
        ...
        <CardContent sx={{ pb: 0 }}>
          <Alert
            id={accountPageElementsIds.activationSectionMessage}
            variant="outlined"
            severity="warning"
          >
        ...
        <CardActions
          sx={{ justifyContent: "center", p: 2, pt: { xs: 1, sm: 2 } }}
        >
          <CooldownButton
            variant="contained"
            color="warning"
