...
export const ActivationMessageNotFound: React.FC<Props> = observer(
  ({ authStore }) => {
    return (
      <>
        ...
        <Box mt={3}>
          <T>
            Убедитесь, что перешли по актуальной ссылке из письма. Если письмо
            не приходит, попробуйте ещё раз.
          </T>
