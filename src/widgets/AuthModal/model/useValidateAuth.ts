...
export const useValidateAuth = (
  setErrors: Dispatch<SetStateAction<{email?: string; password?: string; serverValidation?: string;}>>
) => {

  const validateInput = useCallback((input: 'email' | 'password', value: string) => {
    if (input === 'email') {
