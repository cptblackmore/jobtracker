...
export const DeleteFavoritesModal: React.FC<Props> = observer(
  ({ open, setOpen, handleDeleteFavorites, favoritesStore }) => {
    return (
      <ConfirmationModal
        open={open}
        setOpen={setOpen}
        ...
        onExited={() =>
          ...
          focusElementById(favoritesActionsElementsIds.importButton)
        }
