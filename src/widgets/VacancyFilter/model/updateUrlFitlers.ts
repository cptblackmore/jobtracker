...
export const updateUrlFilters = (newFilters: VacancyParams['filters'], navigate: NavigateFunction): void => {
  ...
  if (!isEqual(parseUrlSearch(currentUrl.search), parseUrlSearch(newSearchString))) {
